...
class Admin_PostController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
		...
		$adapter = new Zend_Paginator_Adapter_DbSelect(
			$db->select()
                ...
                ->where('p.type = ?', PAGE)
                ->where('p.category like ?', '%'.$this->_request->getParam('category').'%')
                ->columns('*', 'p')                
	...
	public function detailAction()
	{
		...
		if($this->_request->isPost())
        {
            if($postForm->isValid($this->_request->getPost()))
			{
				$data = array(
					'type'             => PAGE,
                    'category'         => $postForm->getValue('category'),
                    ...
                    'language'         => $postForm->getValue('language'),
				...
				$this->redirect('/admin/post/index/category/' . $postForm->getValue('category'));
			}
		}
    ...
    protected function getPostForm($post=null)
    {
        ...
        $category->setLabel('Loại bài viết')
				->setRequired(true)
				->addValidator('NotEmpty', true)
				->addErrorMessage('Vui lòng chọn loại bài viết.')
        ...
        $filemedia->setLabel('Hình sản phẩm')
					->setRequired(false)
                    ->addValidator('Count', false, 1)
					->addValidator('Size', false, 2097152)
					->addValidator('Extension', false, 'jpg,png,gif');
        ...
        $language->setRequired(false)
			     ->setValue($this->_request->getParam('language'));
        ...
        $hasRightSidebar->setLabel('Hiện right sidebar')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(true);
        ...
        $hasTopSidebar->setLabel('Hiện top sidebar')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(true);
        ...
        $hasBreadcrumb->setLabel('Hiện breadcrumb')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(false);
        ...
        $hasDescription->setLabel('Hiện description')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(true);
        ...
        $hasContent->setLabel('Hiện content')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(true);
        ...
        $hasSimilarPost->setLabel('Hiện những post tương tự')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(false);
        ...
        $hasMostOfViewPost->setLabel('Hiện những post view cao')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(false);
        ...
        $hasComment->setLabel('Hiện comment')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(false);
        ...
        $hasLikeShare->setLabel('Hiện like share')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(false);
        ...
        $hasAdvertisment->setLabel('Hiện quảng cáo')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(false);
        ...
        $isFrontPage->setLabel('Làm trang chủ')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(false);
        ...
        $isFilterPage->setLabel('Làm trang liệt kê tin tức')
				->setRequired(false)
                ->setCheckedValue(true)
                ->setUncheckedValue(false)
                ->setValue(false);
        ...
        if($post){
            ...
            $language->setValue($post['language']);
